...
from pose_diffusion.util.data_utils import get_image_crop_resize, get_K_crop_resize
...
def parse_args():
    ...
    parser.add_argument("--yolo_box_base_path", default="/scratch/liudan/data/linemod/yolo_detection")

    # Output:
    parser.add_argument(
        "--output_data_dir", type=str, default="/scratch/liudan/data/linemod/LM_dataset"
    )
...
if __name__ == "__main__":
    ...
    model_path = osp.join(args.data_base_dir, "lm_full/models", obj_name, obj_name + ".ply")
    models_info_dict = parse_models_info_txt(
        osp.join(args.data_base_dir, "lm_full/models", "models_info.txt")
    )
